...
func main() {
	...
	adminRoutes.Delete("/products", inventory.DeleteAllProductsHandler())
	...
	protected.Post("/shipments/parse-order-url", inventory.ParseB2BOrderURLHandler(cfg)) // B2B URL parsing endpoint
